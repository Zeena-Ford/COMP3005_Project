...
public class AdministrativeClass {
     ...
     */
    public void roomBookingManagement(String timeFrame){ //right order in parameter
        ...
        try {
            ...
            String querySQL = "UPDATE rooms SET status = 'booked' WHERE workout_time = ?"; //INSERT INTO schedule (trainer_name, member_name, available_date, workout_time, room_number) VALUES (?, ?, ?, ?, ?)";
    ...
    public void classScheduleUpdating(String trainerName, String timeFrame){ //right order in parameter
        //url code containing the local host, user, password and name for the database
        String url = "jdbc:postgresql://localhost:5432/health and fitness management system";
        String user = "postgres";
        String password = "datapass";
        try {
            ...
            String querySQL = "UPDATE schedule SET workout_time = NULL WHERE trainer_name = ? AND workout_time = ?"; //INSERT INTO schedule (trainer_name, member_name, available_date, workout_time, room_number) VALUES (?, ?, ?, ?, ?)";
    ...
    public void billingAndPaymentHistory(String firstName, String lastName, String feeType, int cost){ //right order in parameter
        ...
        try {
            ...
            String querySQL = "UPDATE members SET credit_card_balance = credit_card_balance - 20 WHERE first_name = ? AND last_name = ?; INSERT INTO payment (first_name, last_name, fee_type, amount) VALUES (?,?,?,?)";//INSERT INTO schedule (trainer_name, member_name, available_date, workout_time, room_number) VALUES (?, ?, ?, ?, ?)";
            ...
            prepState.setString(5, feeType);
            prepState.setInt(6, cost);
